...
namespace SistemaLojaMvcApi1.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FuncionarioId,Nome,Sobrenome,Email,Salario,Comissao,DataNascimento,DataCadastro,TipoDocumentoId")] Funcionario funcionario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FuncionarioId,Nome,Sobrenome,Email,Salario,Comissao,DataNascimento,DataCadastro,TipoDocumentoId")] Funcionario funcionario)
        {
            if (ModelState.IsValid)
            {
